...
public class DeltaEncoding {
	...
	public static void main(String[] args) {
		...
		int[] numeri;
		/*
		 * Output Output a delta encoding for the sequence. In a delta encoding, the
		 * first element is reproduced as-is. Each subsequent element is represented as
		 * the numeric difference from the element before it. E.g. for the sequence
		 * above, the delta encoding would be: 25626 131 -1390 -100 -24251 84 -98 7275
		 */
		// => 25626 -128 131 -128 -1390 -100 -128 -24251 84 -98 -128 7275

		Scanner in = new Scanner(System.in);// .toLowerCase()
		/*
		 * while ( in.hasNextInt() ) { numero = in.nextInt(); }
		 */
		...
		int i = 0;
		deltaArray[0] = Integer.parseInt(numbers[0]);
