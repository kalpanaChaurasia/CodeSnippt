...
public class HotelSortForGuestReview {
	 ...
	 * 
	 * @param words
	 *            space-separated set of words which you want to find mentions in
	 *            the hotel reviews
	 * @param reviews
	 *            2D array which contains hotelIds and guest reviews belong to each
	 *            hotel. First column represents hotelIds and second column
	 *            represents respective review
	 * @return a list of hotelIds sorted, in descending order, by how many mentions
	 *         they have of the words specified in the reviews
	 */
	...
	/**
	 * Sort the map and get hotelIds in descending order, by how many mentions they
	 * have of the words specified in the reviews
	 * 
	 * @param hotelReviewCount
	 *            total word count against each hotelId
