...
public class PolygonIdentification {
	 ...
	 * 
	 * @param lines
	 *            list of lines in an array. Each element contains four
	 *            space-separated integers, which represent the length of the sides
	 *            of the polygon
	 * @return a single line which contains 3 space-separated integers; representing
	 ...
	 * 
	 * @param sides
	 *            string type four space-separated integer numbers
	 ...
	 * 
	 * @param sides
	 *            string type four space-separated polygon sides
	...
	/**
	 * If all the sides of the polygon are either negative or positive numbers, then
	 * consider as a valid polygon. Otherwise, consider as a invalid polygon (if one
	 * of the four integers is a negative number)
	 * 
	 * @param line
	 *            array of polygon side lengths
